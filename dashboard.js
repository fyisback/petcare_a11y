...
// Отримуємо проєкти з останніми збереженими оцінками
...
// GET: Головна сторінка (Швидке завантаження з БД)
router.get('/', (req, res) => {
    try {
